...
3. **How do networking and storage work in Docker?**  
   ...
   ווליומס- בווליומס אמצעי האחסון מנוהלים על ידי רכיב הדמון, בוולימס הנתונים מאוחסנים בפייל סיסטם של המכונה המקומית (ההוסט), וכדי שהקונטיינר יוכל לעשות בו שימוש עליו לטעון לתוכו את הווליום הרלוונטי.
   בינד מונטס- בבינד מונטס נוצר קישור בין הקונטיינר לבין ניתוב מסויים במערכת הקבצים של המכונה המקומית, כאשר מבצעים בינד מאונטס, לקונטטיינר יש את היכולת לגשת לכל הקבצים והספריות שמאוחסנים תחת הניתוב הממופה לו.

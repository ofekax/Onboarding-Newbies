...
הRUN - מריץ פקודות (אחת לפחות) שבונות ומגדירות את הדוקר אימג בטרמינל של מערכת ההפעלה הקיימת בביס אימג .
הCMD-  מריץ פקודות באופן דיפולטי כאשר מפעילים קונטיינר מה-אימג.
